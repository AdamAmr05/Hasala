...
const IncomeOverview: React.FC<IncomeOverviewProps> = ({ incomeSources, totalIncome }) => {
    ...
    return (
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100 w-full max-w-sm mx-auto my-2">
            {/* Header */}
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-xl font-bold text-gray-900">{totalIncome.toLocaleString()} EGP</p>
                </div>
            </div>
            ...
            <div className="space-y-4">
                    ...
                    return (
                        <div key={source.name} className="space-y-1">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="font-bold text-gray-900">{source.value.toLocaleString()}</span>
                            </div>
                            ...
                            <div className="h-2 w-full bg-gray-100 rounded-full overflow-hidden">
                                <motion.div
                                    ...
                                    className={`h-full rounded-full ${index === 0 ? 'bg-green-500' :
                ...
                {sortedSources.length === 0 && (
                    <p className="text-center text-gray-400 text-sm py-2">No income recorded this month.</p>
                )}
            </div>
        </div>
    );
