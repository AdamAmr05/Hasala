          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 py-3 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all ${recording ? 'bg-danger text-white animate-pulse' : 'bg-gray-100 text-gray-700'
